...
const FAQS = [
  {
    q: 'What exactly does BotHive run?',
    a: 'BotHive is a control plane for headless Minecraft clients. Each bot forks as an isolated Node process with its own credentials, proxy route, module set and log buffer, supervised by a single control service.',
  },
  {
    q: 'How are proxies handled?',
    a: 'You register SOCKS5 endpoints in the network page. BotHive health-checks them on demand or in bulk, then assigns workers automatically with a hard ceiling of three bots per endpoint so no single route gets saturated.',
  },
  {
