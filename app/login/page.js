...
import { ArrowRight, ArrowLeft, LockKeyhole, UserRound } from 'lucide-react';
    ...
    <main className="grid min-h-screen lg:grid-cols-[minmax(0,1fr)_540px]">
      ...
      <section className="relative hidden overflow-hidden border-r border-white/[0.07] p-14 lg:flex lg:flex-col lg:justify-between">
        ...
        <Link href="/" className="relative flex items-center gap-3">
          <span className="flex h-10 w-10 items-center justify-center rounded-[12px] bg-white text-[13px] font-bold text-black">BH</span>
          <div>
            <strong className="block text-[15px] font-medium tracking-[-0.02em] text-white">BotHive</strong>
      ...
      <section className="relative flex min-h-screen items-center justify-center px-6 py-12 sm:px-12">
        <form onSubmit={submit} className="anim-rise w-full max-w-sm">
          ...
          <div className="mb-8 lg:hidden">
            <span className="flex h-11 w-11 items-center justify-center rounded-[13px] bg-white font-bold text-black">BH</span>
          </div>
