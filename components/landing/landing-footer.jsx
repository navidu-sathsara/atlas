    ...
    <footer className="relative overflow-hidden border-t border-white/[0.07]">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-[1.4fr_repeat(3,1fr)]">
          <div>
            <div className="flex items-center gap-2.5">
              <span className="flex h-8 w-8 items-center justify-center rounded-[10px] bg-white text-[12px] font-bold text-black">BH</span>
              <span className="text-[14px] font-medium tracking-[-0.02em] text-white">BotHive</span>
            </div>
        ...
        <div className="mt-16 flex flex-col gap-4 border-t border-white/[0.07] pt-8 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-[11px] text-white/25">© {new Date().getFullYear()} BotHive. All rights reserved.</p>
